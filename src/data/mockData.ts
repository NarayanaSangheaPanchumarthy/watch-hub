...
export const allShows: Movie[] = [
  ...
  },
  {
    ...
    certification: "TV-MA",
    cast: [
      { name: "Emilia Clarke", character: "Daenerys Targaryen", photo: tmdbProfile("/tB1ggj6uMdKepRVF496FHPVK1K.jpg") },
      { name: "Kit Harington", character: "Jon Snow", photo: tmdbProfile("/4MqUjb1SYrzHmFSyMoNjIy4Ud25.jpg") },
      { name: "Peter Dinklage", character: "Tyrion Lannister", photo: tmdbProfile("/9CAd7sSEtpM2pOAc3oQPDGJiJSL.jpg") },
      { name: "Lena Headey", character: "Cersei Lannister", photo: tmdbProfile("/wciO32sPWoLPV7U6a5JC4VaXjqP.jpg") },
      { name: "Nikolaj Coster-Waldau", character: "Jaime Lannister", photo: tmdbProfile("/3J1nDP1Kh6lqKxMzaKbXTFhdB4G.jpg") },
    ],
    providers: [
      { name: "Max", logo: "M", type: "stream", color: "#002BE7" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    rating: 8.7,
    genres: ["Action", "Adventure", "Sci-Fi"],
    poster: tmdbPoster("/sWgBv7LV2PRoQgkxwlibdGXKz1S.jpg"),
    backdrop: tmdbBackdrop("/9ijMGlJKqcslswWUzTEwScm82Gs.jpg"),
    ...
    certification: "TV-14",
    cast: [
      { name: "Pedro Pascal", character: "Din Djarin", photo: tmdbProfile("/9VYK7oxcqhjd5LAH6ZFJxsBbpZR.jpg") },
      { name: "Carl Weathers", character: "Greef Karga", photo: tmdbProfile("/bEzCVd5sF6VkZd8AC7zL0hP8P5l.jpg") },
      { name: "Giancarlo Esposito", character: "Moff Gideon", photo: tmdbProfile("/lBvDQFCVYwt2yMNq2HpKtR8JfQk.jpg") },
      { name: "Katee Sackhoff", character: "Bo-Katan Kryze", photo: tmdbProfile("/xIbCRIfMz97jnRQFWRzHkuUd3aA.jpg") },
      { name: "Emily Swallow", character: "The Armorer", photo: tmdbProfile("/yIPBEh7WvyOeXQ0q3R6d5kYi7U4.jpg") },
    ],
    providers: [
      { name: "Disney+", logo: "D+", type: "stream", color: "#113CCF" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    backdrop: tmdbBackdrop("/wiE9doxiLwq3WCGamDIOb2PqBqc.jpg"),
    ...
    certification: "TV-MA",
    cast: [
      { name: "Cillian Murphy", character: "Thomas Shelby", photo: tmdbProfile("/dm6V24JJJVKB7UmRbWfmQu7M5Jl.jpg") },
      { name: "Paul Anderson", character: "Arthur Shelby", photo: tmdbProfile("/upHHfa8RnQhAlKp3saLECBYJvnQ.jpg") },
      { name: "Helen McCrory", character: "Polly Gray", photo: tmdbProfile("/7MYIwUF1QiZKRxYbPfGjKFSW0Gn.jpg") },
      { name: "Tom Hardy", character: "Alfie Solomons", photo: tmdbProfile("/d81K0RH8UX7tZj49tZaQhZ9ewH.jpg") },
      { name: "Anya Taylor-Joy", character: "Gina Gray", photo: tmdbProfile("/yZpghhtGk9FBJlJBGMjB3lR1WS.jpg") },
    ],
    providers: [
      { name: "Netflix", logo: "N", type: "stream", color: "#E50914" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    poster: tmdbPoster("/7vjaCdMw15FEbXyLQTVa04URsPm.jpg"),
    backdrop: tmdbBackdrop("/jBJWaqoSCiARWtfV0GlqHrcdiJq.jpg"),
    ...
    certification: "TV-MA",
    cast: [
      { name: "Henry Cavill", character: "Geralt of Rivia", photo: tmdbProfile("/iWdKjMry5Pt7PSiEgVDfBFcOR05.jpg") },
      { name: "Anya Chalotra", character: "Yennefer", photo: tmdbProfile("/v8k4OVlmmR33kzrn7gL6EBkzV28.jpg") },
      { name: "Freya Allan", character: "Ciri", photo: tmdbProfile("/6sRkhONvz2DzK1TIEdpRDNT2SAj.jpg") },
      { name: "Joey Batey", character: "Jaskier", photo: tmdbProfile("/hfPbm8RQMXE9dNH4LbE9NvjHSFP.jpg") },
      { name: "MyAnna Buring", character: "Tissaia de Vries", photo: tmdbProfile("/1JVaolXfOBFDdXJWFMBPKx7X5vm.jpg") },
    ],
    providers: [
      { name: "Netflix", logo: "N", type: "stream", color: "#E50914" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    backdrop: tmdbBackdrop("/3lBDg3i6nn5R2NKFCJ6oKyUo2N5.jpg"),
    overview: "A family saga with a supernatural twist, set in a German town where the disappearance of two young children exposes relationships among four families.",
    runtime: "60min",
    type: "tv",
    seasons: 3,
    certification: "TV-MA",
    cast: [
      { name: "Louis Hofmann", character: "Jonas Kahnwald", photo: tmdbProfile("/yBsmEZDyBpYvfb5Hls5nGZo82gS.jpg") },
      { name: "Lisa Vicari", character: "Martha Nielsen", photo: tmdbProfile("/8cPqUxSxnJx4yWK28gxEMt6byfl.jpg") },
      { name: "Andreas Pietschmann", character: "The Stranger", photo: tmdbProfile("/A2ZCPIBo2IKHhakMm27zQef1g7p.jpg") },
      { name: "Maja Schöne", character: "Hannah Kahnwald", photo: tmdbProfile("/dQ3r7BtDPrKtpkgJLr4Bqy2hPIX.jpg") },
      { name: "Oliver Masucci", character: "Ulrich Nielsen", photo: tmdbProfile("/ioNUICKEZh7aW6c7TqRLl5bRSUo.jpg") },
    ],
    providers: [
      { name: "Netflix", logo: "N", type: "stream", color: "#E50914" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    backdrop: tmdbBackdrop("/xGexTKCJDkl12dTW4YCBDXWb1AD.jpg"),
    ...
    certification: "TV-MA",
    cast: [
      { name: "Álvaro Morte", character: "El Profesor", photo: tmdbProfile("/1i3UvIS6DADakVvIcO3XiT8oR4c.jpg") },
      { name: "Úrsula Corberó", character: "Tokyo", photo: tmdbProfile("/81H7svaRFyXhMeGJUl9SNhh2GCC.jpg") },
      { name: "Itziar Ituño", character: "Raquel Murillo", photo: tmdbProfile("/mSuVxN2X7w8bNBKJxhHmP3dCe3v.jpg") },
      { name: "Pedro Alonso", character: "Berlín", photo: tmdbProfile("/nsJNmeBBL33lF2rNGWz5R2g0VnU.jpg") },
      { name: "Miguel Herrán", character: "Río", photo: tmdbProfile("/5kkVjq6eFyXExNDJkHl3iN8PIJY.jpg") },
    ],
    providers: [
      { name: "Netflix", logo: "N", type: "stream", color: "#E50914" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    backdrop: tmdbBackdrop("/900tHlUYUkp7Ol04XFPnQAAgD78.jpg"),
    ...
    certification: "TV-MA",
    cast: [
      { name: "Jared Harris", character: "Valery Legasov", photo: tmdbProfile("/2LJu6TxB9JMFAFkMd7AyVAT3WTv.jpg") },
      { name: "Stellan Skarsgård", character: "Boris Shcherbina", photo: tmdbProfile("/x8KKnvPKnnR8OFJQAT3WNoeSLPz.jpg") },
      { name: "Emily Watson", character: "Ulana Khomyuk", photo: tmdbProfile("/wn5X1k6t2AaRSv3hm9Q7s2rZyIf.jpg") },
      { name: "Paul Ritter", character: "Anatoly Dyatlov", photo: tmdbProfile("/53r8RGaeJAiO4jPPNNY1n5sYn5j.jpg") },
      { name: "Jessie Buckley", character: "Lyudmilla Ignatenko", photo: tmdbProfile("/9niC2kDaJ1VE2VhMLDM7nh5nLEn.jpg") },
    ],
    providers: [
      { name: "Max", logo: "M", type: "stream", color: "#002BE7" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    poster: tmdbPoster("/stTEycfG9Ee3BiQrA46R3hNpJHs.jpg"),
    backdrop: tmdbBackdrop("/7OMA588NO4DTi5d4BwYxDPLBUxE.jpg"),
    ...
    certification: "TV-MA",
    cast: [
      { name: "Karl Urban", character: "Billy Butcher", photo: tmdbProfile("/tMh1JO9g7mSTn1zPCsjVMvJnPUj.jpg") },
      { name: "Jack Quaid", character: "Hughie Campbell", photo: tmdbProfile("/8GKFMD7M2F8Hse0lVzE7cjra67r.jpg") },
      { name: "Antony Starr", character: "Homelander", photo: tmdbProfile("/6s7or0dHyepLsVnf0zBMS3Y4nBs.jpg") },
      { name: "Erin Moriarty", character: "Starlight", photo: tmdbProfile("/7WKJBBm6v7kEE3d2u5xbMiyXuB7.jpg") },
      { name: "Jessie T. Usher", character: "A-Train", photo: tmdbProfile("/oaJMISU0aFrPLGQFa4JhiDLCEzH.jpg") },
    ],
    providers: [
      { name: "Prime Video", logo: "P", type: "stream", color: "#00A8E1" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
    ],
    trailerKey: "tcrNsUlk4bo",
  },
  {
    id: "tv-19",
    title: "Arcane",
    ...
    poster: tmdbPoster("/fqldf2t8ztc9aiwn3k6mlX3tvRT.jpg"),
    backdrop: tmdbBackdrop("/rkB4LyikAssJzGVX247ojSBB5pA.jpg"),
    ...
    certification: "TV-14",
    cast: [
      { name: "Hailee Steinfeld", character: "Vi (voice)", photo: tmdbProfile("/dxSDHkPvC1GaFP8MgsMmdmqR6m.jpg") },
      { name: "Ella Purnell", character: "Jinx (voice)", photo: tmdbProfile("/vTLSgIRyoUOJfXBrlFTyqIBmmQ5.jpg") },
      { name: "Katie Leung", character: "Caitlyn (voice)", photo: tmdbProfile("/b0OrufuVSyEPZL6Gv5qxjNFXwGK.jpg") },
      { name: "Kevin Alejandro", character: "Jayce (voice)", photo: tmdbProfile("/9FhbMDUfUySbOhFb9i4jJKerLEr.jpg") },
      { name: "Jason Spisak", character: "Silco (voice)", photo: tmdbProfile("/zADjFAVpqHs9Wqgr08QFAXV6sCG.jpg") },
    ],
    providers: [
      { name: "Netflix", logo: "N", type: "stream", color: "#E50914" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
  ...
  },
  {
    ...
    rating: 8.9,
    genres: ["Crime", "Drama", "Mystery"],
    poster: tmdbPoster("/aowr4xpLP5sRCL50TkuADomJ98T.jpg"),
    backdrop: tmdbBackdrop("/fEe50YiZS2JUNiZHgOOsU7TYH5w.jpg"),
    overview: "Anthology series in which police investigations unearth the personal and professional secrets of those involved, both combatants and victims.",
    runtime: "55min",
    type: "tv",
    seasons: 4,
    certification: "TV-MA",
    cast: [
      { name: "Matthew McConaughey", character: "Rust Cohle", photo: tmdbProfile("/sY2mwpafMwMOJECMfXkB5pVPH2c.jpg") },
      { name: "Woody Harrelson", character: "Marty Hart", photo: tmdbProfile("/igxYDQBbTEdAqaJxaW6jhqkMEOk.jpg") },
      { name: "Jodie Foster", character: "Liz Danvers", photo: tmdbProfile("/BZxvVmBGkBo9m0rPRjilV2jLRv.jpg") },
      { name: "Colin Farrell", character: "Ray Velcoro", photo: tmdbProfile("/lKO4MFSdCjdE7bHsWCGQnGgnl3b.jpg") },
      { name: "Mahershala Ali", character: "Wayne Hays", photo: tmdbProfile("/5MBMTn7S2aP8V8VCVqU1lAIlhXA.jpg") },
    ],
    providers: [
      { name: "Max", logo: "M", type: "stream", color: "#002BE7" },
      { name: "YouTube", logo: "YT", type: "stream", color: "#FF0000" },
    ],
    trailerKey: "fVQUcaO4AvE",
  },
];
