...
export const sportsGames: Game[] = [
  ...
  {
    id: "f1", sport: "Football", sportIcon: "🏈", league: "NFL - Super Bowl LIX",
    team1: { name: "Kansas City Chiefs", logo: "🔴", score: 22 },
    team2: { name: "Philadelphia Eagles", logo: "🟢", score: 38 },
    status: "finished", date: fmt(-1), time: "Final",
    venue: "Caesars Superdome", channel: "FOX",
    highlightVideo: "-rOmWIERvzo", highlightTitle: "Chiefs vs Eagles | Super Bowl LIX Game Highlights",
  },
  {
    id: "f2", sport: "Football", sportIcon: "🏈", league: "NFL",
    team1: { name: "Kansas City Chiefs", logo: "🔴", score: 27 },
    team2: { name: "Dallas Cowboys", logo: "⭐", score: 19 },
    status: "finished", date: fmt(-1), time: "Final",
    venue: "AT&T Stadium", channel: "CBS",
    highlightVideo: "qLBGJPw-dSM", highlightTitle: "Chiefs vs Cowboys Thanksgiving Highlights",
  },
  {
    id: "f3", sport: "Football", sportIcon: "🏈", league: "NFL",
    team1: { name: "Buffalo Bills", logo: "🔵", score: 35 },
    team2: { name: "Cincinnati Bengals", logo: "🟠", score: 28 },
    status: "finished", date: fmt(-3), time: "Final",
    venue: "Highmark Stadium", channel: "CBS",
    highlightVideo: "u_RZTVRMNgA", highlightTitle: "Bills Huge Comeback vs Bengals Highlights",
  },
  {
    id: "f4", sport: "Soccer", sportIcon: "⚽", league: "Champions League Final",
    team1: { name: "Borussia Dortmund", logo: "🟡", score: 0 },
    team2: { name: "Real Madrid", logo: "⚪", score: 2 },
    status: "finished", date: fmt(-2), time: "Final",
    venue: "Wembley Stadium", channel: "CBS Sports",
    highlightVideo: "tldOtltdPXY", highlightTitle: "Dortmund vs Real Madrid | UCL Final Extended Highlights",
  },
  {
    id: "f5", sport: "Soccer", sportIcon: "⚽", league: "Premier League",
    team1: { name: "Arsenal", logo: "🔴", score: 5 },
    team2: { name: "Manchester City", logo: "🔵", score: 1 },
    status: "finished", date: fmt(-1), time: "Final",
    venue: "Emirates Stadium", channel: "NBC Sports",
    highlightVideo: "f3POqcfPJZ8", highlightTitle: "Arsenal 5-1 Manchester City | Extended Highlights",
  },
  {
    id: "f6", sport: "Soccer", sportIcon: "⚽", league: "Premier League",
    team1: { name: "Manchester City", logo: "🔵", score: 0 },
    team2: { name: "Liverpool", logo: "🔴", score: 2 },
    status: "finished", date: fmt(-2), time: "Final",
    venue: "Etihad Stadium", channel: "NBC Sports",
    highlightVideo: "cZuKoVpIc9E", highlightTitle: "Manchester City vs Liverpool | Premier League Highlights",
  },
  {
    id: "f7", sport: "Soccer", sportIcon: "⚽", league: "La Liga",
    team1: { name: "Barcelona", logo: "🔵", score: 5 },
    team2: { name: "Sevilla", logo: "⚪", score: 2 },
    status: "finished", date: fmt(-2), time: "Final",
    venue: "Camp Nou", channel: "ESPN+",
    highlightVideo: "s4oX2OOtOKs", highlightTitle: "FC Barcelona 5 vs 2 Sevilla | La Liga Highlights",
  },
  {
    id: "f8", sport: "Cricket", sportIcon: "🏏", league: "T20 World Cup Final",
    ...
    highlightVideo: "cFwFnxDclbM", highlightTitle: "India's Epic T20 World Cup Final Win Over South Africa",
  },
  {
    id: "f9", sport: "Cricket", sportIcon: "🏏", league: "IPL 2026",
    team1: { name: "Mumbai Indians", logo: "🔵", score: "198/5 (20)" },
    team2: { name: "Kolkata Knight Riders", logo: "🟣", score: "175/8 (20)" },
    status: "finished", date: fmt(-1), time: "MI won by 23 runs",
    venue: "Wankhede Stadium", channel: "Star Sports",
    highlightVideo: "r7FE7tIBfKM", highlightTitle: "MI vs KKR | IPL 2026 Highlights",
  },
  {
    id: "f10", sport: "Cricket", sportIcon: "🏏", league: "IPL 2026",
    team1: { name: "Royal Challengers Bengaluru", logo: "🔴", score: "192/4 (20)" },
    team2: { name: "Sunrisers Hyderabad", logo: "🟠", score: "188/6 (20)" },
    status: "finished", date: fmt(-2), time: "RCB won by 4 runs",
    venue: "M. Chinnaswamy Stadium", channel: "Star Sports",
    highlightVideo: "5kTa-1Rdits", highlightTitle: "RCB vs SRH | IPL 2026 Highlights",
  },
  {
    id: "f11", sport: "NBA", sportIcon: "🏀", league: "NBA Finals",
    team1: { name: "Dallas Mavericks", logo: "🔵", score: 88 },
    team2: { name: "Boston Celtics", logo: "🟢", score: 106 },
    status: "finished", date: fmt(-2), time: "Final",
    venue: "TD Garden", channel: "ESPN",
    highlightVideo: "6kW6N2Ax9XA", highlightTitle: "Mavericks at Celtics | NBA Finals Game 5 Highlights",
  },
  {
    id: "f12", sport: "NBA", sportIcon: "🏀", league: "NBA Playoffs",
    team1: { name: "LA Lakers", logo: "🟣", score: 98 },
    team2: { name: "Minnesota Timberwolves", logo: "🔵", score: 116 },
    status: "finished", date: fmt(-1), time: "Final",
    venue: "Target Center", channel: "TNT",
    highlightVideo: "aku-SVEApxc", highlightTitle: "Lakers at Timberwolves | Full Game Highlights",
  },
  {
    id: "f13", sport: "Tennis", sportIcon: "🎾", league: "Australian Open Final",
    team1: { name: "Jannik Sinner", logo: "🇮🇹", score: "3" },
    team2: { name: "Alexander Zverev", logo: "🇩🇪", score: "0" },
    status: "finished", date: fmt(-3), time: "Sinner wins 3-0",
    venue: "Rod Laver Arena", channel: "ESPN",
    highlightVideo: "F5B1QpU0Evo", highlightTitle: "Sinner vs Zverev | Australian Open 2025 Final Highlights",
  },
  {
    id: "f14", sport: "Boxing", sportIcon: "🥊", league: "Undisputed Heavyweight",
    ...
    highlightVideo: "6hVcBKxXTXc", highlightTitle: "Usyk vs Fury | Full Fight Highlights",
  },
  {
    id: "f15", sport: "F1", sportIcon: "🏎️", league: "Formula 1 - Abu Dhabi GP",
    team1: { name: "Max Verstappen", logo: "🇳🇱", score: "1st" },
    team2: { name: "Lando Norris", logo: "🇬🇧", score: "2nd" },
    status: "finished", date: fmt(-4), time: "Final",
    venue: "Yas Marina Circuit", channel: "ESPN",
    highlightVideo: "S-LMSpzlnc0", highlightTitle: "2025 Abu Dhabi Grand Prix | Race Highlights",
  },
  {
    id: "f16", sport: "F1", sportIcon: "🏎️", league: "Formula 1 - Las Vegas GP",
    team1: { name: "Lando Norris", logo: "🇬🇧", score: "1st" },
    team2: { name: "Max Verstappen", logo: "🇳🇱", score: "2nd" },
    status: "finished", date: fmt(-6), time: "Final",
    venue: "Las Vegas Strip Circuit", channel: "ESPN",
    highlightVideo: "uQc-pW3QLuI", highlightTitle: "2025 Las Vegas Grand Prix | Race Highlights",
  },
];
